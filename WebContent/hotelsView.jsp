		...
		<div id="container">
			...
			<div id="header">
				...
				<ul class="menu">
					...
					<!-- richamare il change experiencee -->
		...
		<!--  	<form method="POST" action="prova.jsp"> -->
			...
			<div id="content" class="form-group" align="center">
				...
				<div id="box1" class="form-group" align="center" style="border-right-style: solid; border-right-width: thin;">
  						...
  						<input type="date" required name="datein" size="10" placeholder="yyyy-mm-dd"  style="margin-right: 40px;">
  						<input type="date" required name="dateout" size="10"  placeholder="yyyy-mm-dd" ><br>
